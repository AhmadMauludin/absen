...
<div class="row">
  <div class="col-md-12">
    <div class="page-header">
      ...
      <button type="button" class="btn btn-outline-primary"><b>Perizinan</b>
      </button>
        ...
        <form class="form-inline" method="POST" action="index.php">
          <div class="form-group">
            <div class="input-group">
              ...
              <input type="text" class="form-control" name="cari" placeholder="Tanggal / Nama" autocomplete="off" value="<?php echo $cari; ?>">
            </div>
          </div>
        </form>
      </div>
