...
<div class="row">
  <div class="col-md-12">
    <div class="page-header">
      ...
      <button type="button" class="btn btn-outline-primary"><b>Santri</b>
      </button>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <tbody>
              ...
              $no = 1;
              if (isset($cari)) {
                $query = mysqli_query($db, "SELECT * FROM santri
                                            WHERE nis LIKE '%$cari%' OR nama LIKE '%$cari%' 
                                            ORDER BY nis DESC LIMIT $mulai, $batas")
                  or die('Ada kesalahan pada query santri: ' . mysqli_error($db));
              } else {
                $query = mysqli_query($db, "SELECT * FROM santri
                                            ORDER BY nis DESC LIMIT $mulai, $batas")
                  or die('Ada kesalahan pada query santri: ' . mysqli_error($db));
